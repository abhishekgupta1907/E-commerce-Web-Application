...
const Banner = ({ data }) => {
  return <div className="min-h-[550px] flex justify-center items-center
  py-12">
    <div className="container">
      ...
      items-center text-white rounded-3xl">
        ...
        <div className="p-6 sm:p-8">
          ...
          <h1 data-aos="zoom-out"className="uppercase text-4xl lg:text-7xl
          font-bold">
          {" "}
          {data.title}
          </h1>
        ...
        sm:p-8">
          ...
          <p data-aos="fade-up" className="text-3xl sm:text-5xl font-bold">{data.
          title3}</p>
